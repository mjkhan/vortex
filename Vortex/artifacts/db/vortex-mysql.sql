...
CREATE TABLE TBL_GROUP (
	...
	STATUS   VARCHAR(3)	 NOT NULL DEFAULT '001' COMMENT '상태(001:활성, 998:비활성, 999:제거)',
...
CREATE TABLE TBL_ROLE (
	ROLE_ID   VARCHAR(3)  NOT NULL COMMENT '역할 아이디',
...
CREATE TABLE TBL_ROLE_USER (
	ROLE_ID   VARCHAR(3)  NOT NULL COMMENT '역할 아이디',
	USER_TYPE VARCHAR(3)  NOT NULL COMMENT '사용자 유형',
	USER_ID   VARCHAR(32) NOT NULL COMMENT '사용자 아이디',
	INS_ID    VARCHAR(32) NOT NULL COMMENT '생성자 아이디',
	INS_TIME  DATETIME    NOT NULL COMMENT '생성 일시',
	PRIMARY KEY (ROLE_ID, USER_TYPE, USER_ID)
...
CREATE TABLE TBL_MENU (
	...
	ACT_ID    VARCHAR(32)      NULL COMMENT '액션 아이디',
