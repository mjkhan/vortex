...
CREATE TABLE TBL_USER (
    ...
    PASSWD_UPD   DATETIME    NOT NULL COMMENT '비밀번호 변경 일시',
    LAST_LOGIN   DATETIME        NULL COMMENT '마지막 로그인 일시',
    FAILED_LOGIN INT         NOT NULL DEFAULT 0 COMMENT '로그인 실패횟수',
	...
	STATUS       VARCHAR(3)  NOT NULL DEFAULT '001' COMMENT '상태(001:활성, 900:잠김, 999:제거)',
	PRIMARY KEY (USER_ID)
) COMMENT '사용자 정보';
...
SELECT '001', '001', '엔티티 상태', '엔티티 상태 테이블.STATUS', 'admin', CURRENT_TIMESTAMP(), 'admin', CURRENT_TIMESTAMP(), '001' UNION
SELECT '001', '002', '엔티티 유형', 'TBL_GROUP_MEMBER.MB_TYPE', 'admin', CURRENT_TIMESTAMP(), 'admin', CURRENT_TIMESTAMP(), '001';
...
INSERT INTO TBL_CMN_CODE (GRP_ID, CD_ID, CD_VAL, UPD_ID, UPD_TIME, STATUS)
SELECT '001', '000', '생성', 'admin', CURRENT_TIMESTAMP(), '001' UNION
SELECT '001', '001', '활성', 'admin', CURRENT_TIMESTAMP(), '001' UNION
SELECT '001', '998', '비활성', 'admin', CURRENT_TIMESTAMP(), '001' UNION
SELECT '001', '999', '삭제', 'admin', CURRENT_TIMESTAMP(), '001' UNION

SELECT '002', '000', '사용자', 'admin', CURRENT_TIMESTAMP(), '001' UNION
SELECT '002', '001', '권한', 'admin', CURRENT_TIMESTAMP(), '001';

DROP TABLE IF EXISTS TBL_PERMISSION;
CREATE TABLE TBL_PERMISSION (
	PMS_ID    VARCHAR(32) NOT NULL COMMENT '권한 아이디',
	PMS_NAME  VARCHAR(32) NOT NULL COMMENT '권한 이름',
	DESCRP    TEXT            NULL COMMENT '권한 설명',
	UPD_ID    VARCHAR(32) NOT NULL COMMENT '수정자 아이디',
	UPD_TIME  DATETIME    NOT NULL COMMENT '수정 일시',
	PRIMARY KEY (PMS_ID),
	UNIQUE (PMS_NAME)
...
CREATE TABLE TBL_FILE (
	...
	FILE_TYPE VARCHAR(3)   NOT NULL COMMENT '파일 유형',
	FILE_NAME VARCHAR(64)  NOT NULL COMMENT '파일 이름',
	FILE_PATH VARCHAR(256) NOT NULL COMMENT '파일 경로',
	CNT_TYPE  VARCHAR(128) NOT NULL COMMENT 'MIME type',
	DESCRP    TEXT             NULL COMMENT '파일 설명',
