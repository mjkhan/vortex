...
<c:set var="item">${!empty param.itemName ? param.itemName : '그룹'}</c:set>
<table class="infoList">
	...
	<tbody id="_groupList">
		<c:set var="notFound"><tr><td colspan="3" class="notFound">${item}정보를 찾지 못했습니다.</td></c:set>
...
function _searchGroups(start) {
	ajax({
		url:"<c:url value='/group/select.do'/>",
		data:{
