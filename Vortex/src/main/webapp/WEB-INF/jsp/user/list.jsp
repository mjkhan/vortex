...
<link rel="shortcut icon" href="<c:url value='/asset/image/favicon.ico'/>" type="image/x-icon" />
<link rel="icon" href="<c:url value='/asset/image/favicon.ico'/>" type="image/x-icon" />
<title>Vortex</title>
</head>
<body>
<header>
